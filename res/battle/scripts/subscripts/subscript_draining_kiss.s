...
_000:
    ...
    CompareVarToValue OPCODE_EQU, BTLVAR_HP_CALC_TEMP, 0, _013
    UpdateVar OPCODE_MUL, BTLVAR_HP_CALC_TEMP, 3
    UpdateVar OPCODE_DIV, BTLVAR_HP_CALC_TEMP, 4

_013:
    CheckItemHoldEffect CHECK_NOT_HAVE, BTLSCR_ATTACKER, HOLD_EFFECT_LEECH_BOOST, _033
...
_033:
    ...
    CheckAbility CHECK_HAVE, BTLSCR_DEFENDER, ABILITY_LIQUID_OOZE, _079
    CompareMonDataToValue OPCODE_NEQ, BTLSCR_ATTACKER, BATTLEMON_HEAL_BLOCK_TURNS, 0, _066
...
_079:
    CheckAbility CHECK_HAVE, BTLSCR_ATTACKER, ABILITY_MAGIC_GUARD, _092
    Call BATTLE_SUBSCRIPT_UPDATE_HP
