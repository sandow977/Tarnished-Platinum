...
const ItemArchiveIDs sItemArchiveIDs[] = {
    ...
    [ITEM_SHINY_SPRAY] = {
        .dataID = 0x71,
        .iconID = shiny_spray_NCGR,
        .paletteID = shiny_spray_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_ADAMANT_MINT] = {
        .dataID = 0x1BF,
        .iconID = adamant_mint_NCGR,
        .paletteID = adamant_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_BOLD_MINT] = {
        .dataID = 0x1C0,
        .iconID = bold_mint_NCGR,
        .paletteID = bold_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_BRAVE_MINT] = {
        .dataID = 0x1C1,
        .iconID = brave_mint_NCGR,
        .paletteID = brave_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_CALM_MINT] = {
        .dataID = 0x1C2,
        .iconID = calm_mint_NCGR,
        .paletteID = calm_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_CAREFUL_MINT] = {
        .dataID = 0x1C3,
        .iconID = careful_mint_NCGR,
        .paletteID = careful_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_GENTLE_MINT] = {
        .dataID = 0x1C4,
        .iconID = gentle_mint_NCGR,
        .paletteID = gentle_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_HASTY_MINT] = {
        .dataID = 0x1C5,
        .iconID = hasty_mint_NCGR,
        .paletteID = hasty_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_IMPISH_MINT] = {
        .dataID = 0x1C6,
        .iconID = impish_mint_NCGR,
        .paletteID = impish_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_JOLLY_MINT] = {
        .dataID = 0x1C7,
        .iconID = jolly_mint_NCGR,
        .paletteID = jolly_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_LAX_MINT] = {
        .dataID = 0x1C8,
        .iconID = lax_mint_NCGR,
        .paletteID = lax_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_LONELY_MINT] = {
        .dataID = 0x1C9,
        .iconID = lonely_mint_NCGR,
        .paletteID = lonely_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_MILD_MINT] = {
        .dataID = 0x1CA,
        .iconID = mild_mint_NCGR,
        .paletteID = mild_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_MODEST_MINT] = {
        .dataID = 0x1CB,
        .iconID = modest_mint_NCGR,
        .paletteID = modest_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_NAIVE_MINT] = {
        .dataID = 0x1CC,
        .iconID = naive_mint_NCGR,
        .paletteID = naive_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_NAUGHTY_MINT] = {
        .dataID = 0x1CD,
        .iconID = naughty_mint_NCGR,
        .paletteID = naughty_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_QUIET_MINT] = {
        .dataID = 0x1CE,
        .iconID = quiet_mint_NCGR,
        .paletteID = quiet_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_RASH_MINT] = {
        .dataID = 0x1CF,
        .iconID = rash_mint_NCGR,
        .paletteID = rash_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_RELAXED_MINT] = {
        .dataID = 0x1D0,
        .iconID = relaxed_mint_NCGR,
        .paletteID = relaxed_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_SASSY_MINT] = {
        .dataID = 0x1D1,
        .iconID = sassy_mint_NCGR,
        .paletteID = sassy_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_SERIOUS_MINT] = {
        .dataID = 0x1D2,
        .iconID = serious_mint_NCGR,
        .paletteID = serious_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_TIMID_MINT] = {
        .dataID = 0x1D3,
        .iconID = timid_mint_NCGR,
        .paletteID = timid_mint_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_ADAMANT_ORB] = {
        .dataID = 0x72,
    ...
    [ITEM_FIRE_GEM] = {
        .dataID = 0x1D4,
        .iconID = fire_gem_NCGR,
        .paletteID = fire_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_WATER_GEM] = {
        .dataID = 0x1D5,
        .iconID = water_gem_NCGR,
        .paletteID = water_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_ELECTRIC_GEM] = {
        .dataID = 0x1D6,
        .iconID = electric_gem_NCGR,
        .paletteID = electric_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_GRASS_GEM] = {
        .dataID = 0x1D7,
        .iconID = grass_gem_NCGR,
        .paletteID = grass_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_ICE_GEM] = {
        .dataID = 0x1D8,
        .iconID = ice_gem_NCGR,
        .paletteID = ice_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_FIGHTING_GEM] = {
        .dataID = 0x1D9,
        .iconID = fighting_gem_NCGR,
        .paletteID = fighting_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_POISON_GEM] = {
        .dataID = 0x1DA,
        .iconID = poison_gem_NCGR,
        .paletteID = poison_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_GROUND_GEM] = {
        .dataID = 0x1DB,
        .iconID = ground_gem_NCGR,
        .paletteID = ground_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_FLYING_GEM] = {
        .dataID = 0x1DC,
        .iconID = flying_gem_NCGR,
        .paletteID = flying_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_PSYCHIC_GEM] = {
        .dataID = 0x1DD,
        .iconID = psychic_gem_NCGR,
        .paletteID = psychic_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_BUG_GEM] = {
        .dataID = 0x1DE,
        .iconID = bug_gem_NCGR,
        .paletteID = bug_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_ROCK_GEM] = {
        .dataID = 0x1DF,
        .iconID = rock_gem_NCGR,
        .paletteID = rock_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_GHOST_GEM] = {
        .dataID = 0x1E0,
        .iconID = ghost_gem_NCGR,
        .paletteID = ghost_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_DRAGON_GEM] = {
        .dataID = 0x1E1,
        .iconID = dragon_gem_NCGR,
        .paletteID = dragon_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_DARK_GEM] = {
        .dataID = 0x1E2,
        .iconID = dark_gem_NCGR,
        .paletteID = dark_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_STEEL_GEM] = {
        .dataID = 0x1E3,
        .iconID = steel_gem_NCGR,
        .paletteID = steel_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_NORMAL_GEM] = {
        .dataID = 0x1E4,
        .iconID = normal_gem_NCGR,
        .paletteID = normal_gem_NCLR,
        .gen3ID = GBA_ITEM_NONE,
    },
    [ITEM_FAIRY_GEM] = {
        .dataID = 0x1E5,
        .iconID = fairy_gem_NCGR,
...
{
    int maxItem = Item_FileID(NUM_ITEMS, ITEM_FILE_TYPE_DATA) + 1;
