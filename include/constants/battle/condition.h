...
#define VOLATILE_CONDITION_LASER_FOCUS (1 << 7)
...
#define SIDE_CONDITION_STICKY_WEB   (1 << 12)
#define SIDE_CONDITION_LUCKY_CHANT_0 (1 << 13)
#define SIDE_CONDITION_LUCKY_CHANT_1 (1 << 14)
#define SIDE_CONDITION_LUCKY_CHANT_2 (1 << 15)
