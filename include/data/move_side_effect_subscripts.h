...
static const int sSideEffectSubscripts[] = {
    ...
    [MOVE_SUBSCRIPT_PTR_BURN_UP]                          = subscript_burn_up,
    [MOVE_SUBSCRIPT_PTR_CHLOROBLAST]                      = subscript_chloroblast,
    [MOVE_SUBSCRIPT_PTR_DOUBLE_SHOCK]                     = subscript_double_shock,
    ...
    [MOVE_SUBSCRIPT_PTR_THOUSAND_ARROWS]                  = subscript_thousand_arrows,
    [MOVE_SUBSCRIPT_PTR_TOXIC_THREAD]                     = subscript_toxic_thread,
    [MOVE_SUBSCRIPT_PTR_SCALE_SHOT]                       = subscript_scale_shot,
    [MOVE_SUBSCRIPT_PTR_SOAK]                             = subscript_soak,
    [MOVE_SUBSCRIPT_PTR_METEOR_BEAM]                      = subscript_power_herb_meteor_beam,
    [MOVE_SUBSCRIPT_PTR_THROAT_CHOP]                      = subscript_throat_chop,
    [MOVE_SUBSCRIPT_PTR_GROWTH]                           = subscript_growth,
    [MOVE_SUBSCRIPT_PTR_TAIL_GLOW]                        = subscript_tail_glow,
    [MOVE_SUBSCRIPT_PTR_DRAINING_KISS]                    = subscript_draining_kiss,
    [MOVE_SUBSCRIPT_PTR_PSYCHIC_NOISE]                    = subscript_psychic_noise,
};
// clang-format on
